...
//         <div className=" w-full h-[10%] font-pricedown flex justify-end static mb-4 bg-[#52b69a] rounded-2xl">
...
//           <div className="text-wrap  max-h-full flex-grow flex-wrap w-full flex gap-3 p-1 justify-center items-center">
//           {loading ? (
//               <p>Loading...</p>
//             ) : (
//               jobs.map((job) => (
//                 <CareerBox key={job._id} jobName={job.name} {...job} />
//               ))
//             )}
//           </div>
...
// import CloseIcon from "@mui/icons-material/Close";
// import { Button } from "@mui/material";
// // import { Career } from "../../context/trialIndex";
// import CareerBox from "./CareerBox";
...
//       <div className=" bg-gray-200 w-[80%] h-[90%] z-10 flex  justify-around items-center flex-col p-4 rounded-2xl">
//         <div className=" w-full h-[10%] font-pricedown flex justify-end static mb-4 bg-[#52b69a] rounded-2xl">
//           <h2 className="text-black flex justify-center items-center w-full h-full text-3xl sm:text-4xl text-nowrap  ">
//             Careers at LSPD
//           </h2>

//           <Button onClick={onClose}>
//             <CloseIcon className="text-black" sx={{ fontSize: 16 }}  />
//           </Button>
//         </div>
//         <div className="w-full h-full overflow-hidden overflow-y-auto">
//           <div className="text-wrap  max-h-full flex-grow flex-wrap w-full flex gap-3 p-1 justify-center items-center">
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50 h-screen w-screen ">
      ...
      <div className=" bg-gray-200 w-[80%] h-[90%] z-10 flex  justify-around items-center flex-col p-4 rounded-2xl">
        ...
        <div className="w-full h-full overflow-hidden overflow-y-auto  ">
          <div className="text-wrap  max-h-full flex-grow flex-wrap w-[98%] flex gap-3 p-1 justify-center items-center">
            {jobs.map((career) => {
              return (
                <CareerBox
                  key={career.name}
