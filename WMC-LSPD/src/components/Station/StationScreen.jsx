...
import Exit from "./Exit"; // Import the Exit component
...
const StationScreen = () => {
  ...
  return (
    <div className="relative lg:max-h-[220vh] lg:min-h-[220vh] h-[100vh] md:w-[100%] lg:w-[100%] md:overflow-hidden md:overflow-y-auto overflow-y-hidden overflow-x-auto lg:overflow-hidden m-0 p-0">
      ...
      <div className="absolute top-[25%] right-[5%] lg:top-[26%] md:right-[23%] lg:right-[47%] flex flex-col justify-center items-center">
        <Exit /> 
      </div>
      <div
