...
//               <h2 className="text-4xl text-black font-bold w-full flex justify-center">
//                 Submit a Crime Tip
//               </h2>
...
//                 <input
//                   type="text"
//                   className="w-1/2 h-full bg-gray-200 p-3 rounded-md text-lg"
...
//                   value={tip.tipHeader}
//                   onChange={handleInputChange}
//                   className="w-full h-4/5 bg-gray-200 pl-3 rounded text-lg"
...
//                 <textarea
//                   className="w-full max-h-full h-full bg-gray-200  p-3 rounded-md mb-4 overflow-hidden overflow-y-auto text-lg"
//                   rows="4"
